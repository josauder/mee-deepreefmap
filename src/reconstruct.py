...
parser.add_argument('--sfm_checkpoint', type=str, default='../example_data/checkpoints/sfm_net.pth', help='Path to the sfm_net checkpoint')
parser.add_argument('--segmentation_checkpoint', type=str, default='../example_data/checkpoints/segmentation_net.pth', help='Path to the segmentation_net checkpoint')
